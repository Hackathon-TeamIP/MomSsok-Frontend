...
export function TabBar() {
  return (
    <div className="max-w-custom flex w-full items-center justify-between h-[60px] fixed bottom-0 z-[100] border-solid border-t-[1.5px] border-t-gray-200 bg-[#F8F8F8]">
